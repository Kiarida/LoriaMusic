...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/items/xbox')) {
            ...
            // byexample_items_get_search_xboxxxx
            if (0 === strpos($pathinfo, '/items/xboxxxx/search') && preg_match('#^/items/xboxxxx/search(?:\\.(?P<_format>json|xml|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_byexample_items_get_search_xboxxxx;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'byexample_items_get_search_xboxxxx')), array (  '_controller' => 'ByExample\\DemoBundle\\Controller\\ItemRestController::getSearchXboxxxxAction',  '_format' => NULL,));
            }
            not_byexample_items_get_search_xboxxxx:
